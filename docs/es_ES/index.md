...
> **Importante**
>
> Le plugin ne supporte pas les équipement avec des double fonction (2 sortie comme certain module zwave Fibaro). Hay que absolument passer par 2 virtuels pour le décomposer.
