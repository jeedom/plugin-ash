...
> **Wichtig**
>
> Le plugin ne supporte pas les équipement avec des double fonction (2 sortie comme certain module zwave Fibaro). Du musst absolument passer par 2 virtuels pour le décomposer.
